...
echo "👥 Step 10: Creating Authors Page..."
cd "$(dirname "$0")"

# ============================================================
# 1. Add Authors API
# ============================================================
echo "📝 Creating lib/api/authors.ts..."
cat > "lib/api/authors.ts" << 'AUTHORSAPIEOF'
...
# 3. Authors Page
# ============================================================
echo "📝 Creating app/(dashboard)/dashboard/authors/page.tsx..."
cat > "app/(dashboard)/dashboard/authors/page.tsx" << 'AUTHORSPAGEEOF'
'use client'
...
echo ""
echo "✅ Step 10 complete! Authors page created."
